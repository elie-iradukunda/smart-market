...
const ROLE_PERMISSIONS = {
  ...
  [ROLES.ACCOUNTANT]: [PERMISSIONS.INVOICE_CREATE, PERMISSIONS.INVOICE_VIEW, PERMISSIONS.INVOICE_SEND, PERMISSIONS.PAYMENT_CREATE, PERMISSIONS.PAYMENT_VIEW, PERMISSIONS.PAYMENT_REFUND, PERMISSIONS.JOURNAL_CREATE, PERMISSIONS.REPORT_VIEW, PERMISSIONS.CUSTOMER_VIEW],
  ...
  [ROLES.RECEPTION]: [PERMISSIONS.CUSTOMER_MANAGE, PERMISSIONS.LEAD_MANAGE, PERMISSIONS.QUOTE_MANAGE, PERMISSIONS.QUOTE_VIEW, PERMISSIONS.ORDER_VIEW, PERMISSIONS.FILE_UPLOAD, PERMISSIONS.FILE_VIEW],
  [ROLES.TECHNICIAN]: [PERMISSIONS.WORKORDER_VIEW, PERMISSIONS.WORKLOG_CREATE, PERMISSIONS.MATERIAL_VIEW, PERMISSIONS.FILE_VIEW],
