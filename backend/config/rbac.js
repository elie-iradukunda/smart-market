...
const ROLE_PERMISSIONS = {
  ...
  [ROLES.ACCOUNTANT]: [PERMISSIONS.INVOICE_CREATE, PERMISSIONS.INVOICE_VIEW, PERMISSIONS.INVOICE_SEND, PERMISSIONS.PAYMENT_CREATE, PERMISSIONS.PAYMENT_VIEW, PERMISSIONS.PAYMENT_REFUND, PERMISSIONS.JOURNAL_CREATE, PERMISSIONS.REPORT_VIEW, PERMISSIONS.CUSTOMER_VIEW, PERMISSIONS.ORDER_VIEW],
  ...
  [ROLES.RECEPTION]: [PERMISSIONS.CUSTOMER_MANAGE, PERMISSIONS.CUSTOMER_VIEW, PERMISSIONS.LEAD_MANAGE, PERMISSIONS.QUOTE_MANAGE, PERMISSIONS.QUOTE_VIEW, PERMISSIONS.ORDER_VIEW, PERMISSIONS.WORKORDER_VIEW, PERMISSIONS.POS_CREATE, PERMISSIONS.MESSAGE_SEND, PERMISSIONS.CONVERSATION_VIEW, PERMISSIONS.FILE_UPLOAD, PERMISSIONS.FILE_VIEW],
  [ROLES.TECHNICIAN]: [PERMISSIONS.ORDER_VIEW, PERMISSIONS.ORDER_UPDATE, PERMISSIONS.WORKORDER_VIEW, PERMISSIONS.WORKLOG_CREATE, PERMISSIONS.MATERIAL_VIEW, PERMISSIONS.FILE_VIEW],
  [ROLES.PRODUCTION_MANAGER]: [PERMISSIONS.WORKORDER_CREATE, PERMISSIONS.WORKORDER_UPDATE, PERMISSIONS.WORKORDER_VIEW, PERMISSIONS.WORKLOG_CREATE, PERMISSIONS.ORDER_UPDATE, PERMISSIONS.MATERIAL_VIEW, PERMISSIONS.SUPPLIER_VIEW, PERMISSIONS.REPORT_VIEW, PERMISSIONS.FILE_VIEW],
  ...
  [ROLES.SALES_REP]: [PERMISSIONS.CUSTOMER_MANAGE, PERMISSIONS.LEAD_MANAGE, PERMISSIONS.QUOTE_MANAGE, PERMISSIONS.QUOTE_VIEW, PERMISSIONS.QUOTE_APPROVE, PERMISSIONS.ORDER_VIEW, PERMISSIONS.FILE_UPLOAD, PERMISSIONS.FILE_VIEW],
  [ROLES.MARKETING_MANAGER]: [PERMISSIONS.CAMPAIGN_MANAGE, PERMISSIONS.CAMPAIGN_LAUNCH, PERMISSIONS.CUSTOMER_VIEW, PERMISSIONS.REPORT_VIEW, PERMISSIONS.AI_VIEW],
  [ROLES.POS_CASHIER]: [PERMISSIONS.POS_CREATE, PERMISSIONS.CUSTOMER_VIEW, PERMISSIONS.PAYMENT_CREATE],
  [ROLES.SUPPORT_AGENT]: [PERMISSIONS.CONVERSATION_VIEW, PERMISSIONS.MESSAGE_SEND, PERMISSIONS.CUSTOMER_VIEW, PERMISSIONS.FILE_VIEW]
};
