...
const ROLE_PERMISSIONS = {
  ...
  [ROLES.MARKETING_MANAGER]: [PERMISSIONS.CAMPAIGN_MANAGE, PERMISSIONS.CAMPAIGN_LAUNCH, PERMISSIONS.AD_CREATE, PERMISSIONS.AD_VIEW, PERMISSIONS.AD_EDIT, PERMISSIONS.AD_DELETE, PERMISSIONS.CUSTOMER_VIEW, PERMISSIONS.REPORT_VIEW, PERMISSIONS.AI_VIEW],
  'marketing': [PERMISSIONS.CAMPAIGN_MANAGE, PERMISSIONS.CAMPAIGN_LAUNCH, PERMISSIONS.AD_CREATE, PERMISSIONS.AD_VIEW, PERMISSIONS.AD_EDIT, PERMISSIONS.AD_DELETE, PERMISSIONS.CUSTOMER_VIEW, PERMISSIONS.REPORT_VIEW, PERMISSIONS.AI_VIEW],
