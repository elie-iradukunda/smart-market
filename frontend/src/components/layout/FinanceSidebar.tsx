...
const FinanceSidebar = ({ isOpen, setIsOpen }: { isOpen: boolean; setIsOpen: (isOpen: boolean) => void }) => {
    ...
    const [expandedItems, setExpandedItems] = useState<string[]>(['Finance', 'Point of Sale'])
                ...
                <div className="border-t border-blue-200 p-4 space-y-3 bg-white/30">
                    <div className="flex items-center gap-3 rounded-xl bg-white/60 p-3 border border-blue-200">
                        ...
                        <div className="flex-1 overflow-hidden">
                            <p className="truncate text-sm font-semibold text-blue-900">{user?.name || 'Accountant'}</p>
                            <p className="truncate text-xs text-blue-600">Finance Manager</p>
                        </div>
                    </div>
