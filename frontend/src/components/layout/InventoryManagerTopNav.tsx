        ...
        <header className="bg-gradient-to-r from-emerald-900 via-teal-900 to-emerald-900 text-white shadow-lg sticky top-0 z-30 backdrop-blur-sm border-b border-emerald-800/50">
            <div className="mx-auto max-w-7xl px-3 sm:px-4 lg:px-6 h-14 sm:h-16 flex items-center justify-between gap-3 sm:gap-6">
                ...
                <div className="flex items-center gap-3 sm:gap-4 min-w-0 flex-shrink-0">
                    <button
                        type="button"
                        className="md:hidden p-2 rounded-lg text-emerald-200 hover:text-white hover:bg-white/10 transition-colors"
                        onClick={onMenuClick}
                    ...
                    <div className="flex items-center gap-2.5 sm:gap-3">
                        ...
                        <div className="leading-tight hidden sm:block">
                            ...
                            <p className="text-xs sm:text-sm font-bold text-white">Inventory</p>
                        </div>
                    </div>
                </div>
