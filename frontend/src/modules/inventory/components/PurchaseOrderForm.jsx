  ...
  return (
    <form className="grid max-w-md gap-3">
      ...
      <label className="text-sm">
        <span className="block text-gray-700">PO number</span>
        <input
          defaultValue="PO-1001"
      ...
      <label className="text-sm">
        ...
        <input
          defaultValue="PrintSupplies Ltd"
          className="mt-1 w-full rounded border border-gray-300 px-2 py-1 text-sm focus:border-primary-500 focus:outline-none"
        />
      </label>
      <label className="text-sm">
        <span className="block text-gray-700">Expected arrival</span>
        <input
          type="date"
          className="mt-1 w-full rounded border border-gray-300 px-2 py-1 text-sm focus:border-primary-500 focus:outline-none"
        />
