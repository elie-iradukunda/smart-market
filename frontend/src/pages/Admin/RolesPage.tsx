    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50/50 via-white to-purple-50/50 px-4 py-8 sm:px-6 lg:px-8 space-y-8">
      ...
      <div className="rounded-3xl border border-gray-100 bg-white/95 backdrop-blur-xl p-8 shadow-xl">
        ...
        <h1 className="mt-2 text-3xl sm:text-4xl font-extrabold text-gray-900">
          Role-Based <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Access Control</span>
        </h1>
        ...
        <div className="rounded-3xl border border-gray-100 bg-white/95 backdrop-blur-xl p-6 shadow-xl">
          ...
          <form onSubmit={selectedRoleId ? handleSaveRole : handleCreateRole} className="space-y-4">
            ...
            <div>
              ...
              <div className="max-h-64 overflow-y-auto rounded-lg border border-gray-200 bg-gray-50/60 p-3 space-y-2">
